...
mickey = pygame.image.load('static/images/main-clock.png')
leftHand = pygame.image.load('static/images/left-hand.png')
rightHand = pygame.image.load('static/images/right-hand.png')
